...
The function ‘complete’ reads a directory full of files and reports 
the number of completely observed cases in each data file. The function 
  should return a data frame where the first column is the name of 
...
The function ‘corr’ takes a directory of data files and a threshold for complete 
